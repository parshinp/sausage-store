...
curl -u ${NEXUS_REPO_USER}:${NEXUS_REPO_PASS} -o sausage-store.jar ${NEXUS_REPO_URL}/sausage-store-parshin_pavel-backend/com/yandex/practicum/devops/sausage-store/1.0.28685/sausage-store-1.0.28685.jar
